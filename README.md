...
Skapade en contraint layout. Använder match_parent some layout för width och height. 

Lade in en constraint layout. Använde match_parent som width och height med hjälp av nedan kod.
...
Lade in en imageview. Constrainade den till parent och använde wrap_content som width och height.
